...
public class NT {
    ...
    static double kurang(double input[],double sum){
        double red = sum - input[2];
        return red;
    }
    
    static double kali(double input[],double red){
        double tms = red * input[3];
        return tms;
    }
    
    static double bagi(double input[],double tms){
        double div = tms / input[4];
        return div;
    }
    
    static void akhir(double div){
